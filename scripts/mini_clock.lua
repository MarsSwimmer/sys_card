...
seconds_ring_base_color  = {0x0076E8, 0}, -- base color

minutes_ring_fill_color  = {0xD08770, 0}, -- fill color
hours_ring_fill_color  = {0xBF616A, 0.4}, -- fill color
seconds_ring_fill_color = {0x5E81AC, 0.2},

-- Main settings
xc = 204, -- centre of the clock
yc = 178,
R  = 75,  -- default radius of the clock
RH = 55,  -- outher radius for hours fill ring
RM = 57,  -- outer radius for minutes fill ring
...
minute_fill_color = {0xD08770, 1},   -- fill color for minutes ring
hour_fill_color   = {0xBF616A, 1},   -- fill color for hour ring
fill_colorS       = {0x5E81AC, 1},   -- fill color for seconds ring
...
cairo_set_source_rgba(cr, rgba_to_r_g_b_a(t.hours_ring_fill_color))
cairo_arc(cr, t.xc, t.yc, t.RH, -math.pi/2, h_theta)
cairo_stroke(cr)

-- Draw the hours ring fill
cairo_set_line_width(cr, t.border_width)
cairo_set_source_rgba(cr, rgba_to_r_g_b_a(t.hour_fill_color))
...
cairo_set_source_rgba(cr, rgba_to_r_g_b_a(t.minutes_ring_fill_color))
cairo_arc(cr, t.xc, t.yc, t.RM, -math.pi/2, m_theta)
cairo_stroke(cr)

-- Draw the minutes ring fill
cairo_set_line_width(cr, t.border_width)
cairo_set_source_rgba(cr, rgba_to_r_g_b_a(t.minute_fill_color))
